...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("Oct. 14, 09:00AM-01:00PM (online)*", 
                 "Oct. 28, 09:00AM-01:00PM (online)*",
                 "Nov. 11, 09:00AM-01:00PM (online)*",
                 "Nov. 25, 09:00AM-01:00PM (online)*"
             ),
    Submission = c(
      "Oct. 16, 11:59PM",
      "Oct. 30, 11:59PM",
...
mytable_sub_1 %>% kable(escape = F,  col.names = gsub("[_]", " ", names(mytable_sub_1))) %>%
  kable_paper(c("hover"), full_width = F) %>%
  footnote(general = "Dates and times are indicated for group A. 
           Dates indicated with '*' are optional time slots for individual online video coaching sessions with Daria
           If you would like to schedule a meeting during the indicated times, please contact Daria before (daria.yudaeva@wu.ac.at).",
           general_title = "Note: ", 
           footnote_as_chunk = T, title_format = c("italic")
           ) 
...
mytable_sub_1 = data.frame(
    ...
    Coaching = c("Oct. 14, 02:00PM-06:00PM (online)*", 
                 "Oct. 31, 09:00AM-01:00PM (online)*",
                 "Nov. 11, 02:00PM-06:00PM (online)*",
                 "Nov. 25, 02:00PM-06:00PM (online)*"
             ),
    Submission = c(
      "Oct. 18, 11:59PM",
      "Nov. 01, 11:59PM",
...
mytable_sub = data.frame(
    ...
    Date = c(
      "Nov. 21, 01:00PM - 05:00PM",
      "Nov. 28, 12:30PM - 04:30PM",
      "Dec. 12, 01:00PM - 05:00PM",
      "TBA"
    ),
    Room = c(
      "TC.-1.61",
...
mytable_sub = data.frame(
    ...
    Date = c(
      "Nov. 23, 12:00PM - 04:00PM",
      "Nov. 30, 12:00PM - 04:00PM",
      "Dec. 14, 12:00PM - 04:00PM",
      "TBA"
    ),
    Room = c(
      "TC.-1.61",
