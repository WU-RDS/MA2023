...
## ----echo=FALSE,out.width = '25%',fig.align='center',fig.cap = "source: https://twitter.com/heyblake/status/1432070055949258752?s=20"----
...
ggplot(table_plot_cond_rel, aes(x = fct_reorder(genre, Freq), y = Freq)) + 
  geom_col(aes(fill = Freq)) +
      facet_wrap(~explicit, labeller = labeller(explicit = c("0" = "non-explicit", "1" = "explicit"))) +
